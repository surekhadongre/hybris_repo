...
/**
 * This is the extension manager of the Customaddonextension extension.
 */
public class CustomaddonextensionManager extends GeneratedCustomaddonextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomaddonextensionManager.class.getName());
	 ...
	 */
	public static CustomaddonextensionManager getInstance()
	{
		return (CustomaddonextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomaddonextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomaddonextensionManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomaddonextensionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomaddonextensionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomaddonextensionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
