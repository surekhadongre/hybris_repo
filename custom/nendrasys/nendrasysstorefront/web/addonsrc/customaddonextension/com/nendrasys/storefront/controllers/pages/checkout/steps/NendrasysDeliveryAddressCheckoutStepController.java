...
public class NendrasysDeliveryAddressCheckoutStepController extends DeliveryAddressCheckoutStepController {
    ...
    @RequireHardLogIn
    public String add(final @ModelAttribute("addressForm") CustomAddressForm customAddressForm, final BindingResult bindingResult, final Model model,
                      final RedirectAttributes redirectModel) throws CMSItemNotFoundException
    {
        final CartData cartData = getCheckoutFacade().getCheckoutCart();

        getAddressValidator().validate(customAddressForm, bindingResult);
        ...
        final AddressData newAddress = this.addressDataUtil.convertToAddressData(customAddressForm);

        processAddressVisibilityAndDefault(customAddressForm, newAddress);
                                ...
                                final Model model) throws CMSItemNotFoundException
    {
        ...
        model.addAttribute("addressForm", new CustomAddressForm());
    ...
    public String doSelectSuggestedAddress(final CustomAddressForm addressForm, final RedirectAttributes redirectModel)
    {
        ...
        final AddressData selectedAddress = this.addressDataUtil.convertToAddressData(addressForm);
    ...
    protected void populateCommonModelAttributes(final Model model, final CartData cartData, final CustomAddressForm customAddressForm)
            throws CMSItemNotFoundException
    {
        model.addAttribute("cartData", cartData);
        model.addAttribute("addressForm", customAddressForm);
        ...
        if (StringUtils.isNotBlank(customAddressForm.getCountryIso()))
        {
            model.addAttribute("regions", getI18NFacade().getRegionsForCountryIso(customAddressForm.getCountryIso()));
            model.addAttribute("country", customAddressForm.getCountryIso());
        }
