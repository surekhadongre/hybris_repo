...
import com.nendrasys.storefront.register.CustomRegisterForm;
...
public class RegisterPageController extends AbstractRegisterPageController
{
	...
	{
		if (this.httpSessionRequestCache.getRequest(request, response) != null)
		{
			return this.httpSessionRequestCache.getRequest(request, response).getRedirectUrl();
		}
		return "/";
	}
	...
	{
		System.out.println("registerPageController::doRegister1");
		return getDefaultRegistrationPage(model);  //origional
		//modified
		//return this.customRegisterPageController.getDefaultRegistrationPage(model);
	}
	...
	{
		System.out.println("registerPageController::doRegister");
		//modified
		...
		//modified
		//return this.customRegisterPageController.processRegisterUserRequest(null, form, bindingResult, model, request, response, redirectModel);
	}

	public String getDefaultRegistrationPage(final Model model) throws CMSItemNotFoundException
	{
		System.out.println("CustomRegisterPageController:::getDefaultRegistrationPage");
	...
	public String processRegisterUserRequest(final String referer, final CustomRegisterForm form, final BindingResult bindingResult,
											 final Model model, final HttpServletRequest request, final HttpServletResponse response,
											 final RedirectAttributes redirectModel) throws CMSItemNotFoundException // NOSONAR
	{
		System.out.println("CustomRegisterPageController:::processRegisterUserRequest");
		...
		data.setIsBusinessUser(form.isIsBusinessUser());
		try
		{
