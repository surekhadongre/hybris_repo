...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String LatestComponents = _Prefix + LatestProductsComponentModel._TYPECODE + _Suffix; // NOSONAR
		}
	}
	...
	interface Views
	{
		...
		interface Fragments
		{
			...
			interface Product // NOSONAR
			{
				...
				String Flags="fragments/product/flags";
			}


		}

		interface ProductRegistration // NOSONAR
		{
			String ProductRegistrationForm = "pages/productRegistration/product_registration"; // NOSONAR
			String ProductRegistration = "pages/productRegistration/product_registration_success";
			String CAMPAIGNPAGE = "pages/productRegistration/campaignPage";
		}
	}
}
