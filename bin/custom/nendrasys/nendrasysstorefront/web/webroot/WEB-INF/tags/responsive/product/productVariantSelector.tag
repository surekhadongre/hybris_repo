    ...
    <c:otherwise>
        ...
        <c:if test="${not empty variantOptions}">
            <div class="variant-section">
                <div class="variant-selector">
                    <div class="variant-name">
                        <label for="Flags">Flags::  <span
                                class="variant-selected ">${product.FLAGS}</span></label>
                    </div>
                    <div>
                        <label for="ManufacturingDetails">Manufacturing Details:</label>
                        <table>
                            <table border="1" >
                                <thead>
                                <tr>
                                ...
                                <c:forEach items="${product.MANUFACTURINGDETAILS}" var="manufacturingDetails">
                                <tr >
                                    <td><c:out value="${manufacturingDetails.company}"/></td>
                                    <td><c:out value="${manufacturingDetails.country.name}"/></td>
                    ...
                    <div>
                        <p id="manufactureJsonData"></p>

                    </div>
                    <button onclick="manufacturingDetails()">ManufactureDetails</button>
                    <script>
                        ...
                        (){
                            ...
                            xhttp.open('GET','${pageContext.request.contextPath}/p/manufacturingdetails?companyName=ATLANTA', true)
                            xhttp.send();
                        }
                    </script>

                    <div class="variant-name">
                        <label for="CustomSEOKeyword"> <span
                                class="variant-selected ">${product.customSEOKeyword}</span></label>
                    </div>
