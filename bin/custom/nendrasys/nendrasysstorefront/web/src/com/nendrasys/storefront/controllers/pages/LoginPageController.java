...
import com.nendrasys.facades.customRegistration.DefaultCustomRegistrationFacade;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	@Resource(name = "defaultCustomerRegistrationFacade")
	private DefaultCustomRegistrationFacade defaultCustomRegistrationFacade;
	...
	protected void storeReferer(final String referer, final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		{
			this.httpSessionRequestCache.saveRequest(request, response);
		}
	}
