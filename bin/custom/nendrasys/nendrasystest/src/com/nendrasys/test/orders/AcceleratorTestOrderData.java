...
public class AcceleratorTestOrderData
{
	...
	{
		return this.commerceCheckoutService;
	}
	...
	{
		return this.addressReversePopulator;
	}
	...
	{
		return this.baseStoreSelectorStrategy;
	}
			...
			final BillingInfo billingInfo)
	{
		...
		ctx.setCurrency(this.i18nService.getCurrency(currencyIso));
